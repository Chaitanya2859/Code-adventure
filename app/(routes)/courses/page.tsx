  ...
  return (
    <div>
        <div className="relative ">
            <Image src={'/hero-8.gif'} alt='course-banner' height={100} width={1200} className='w-full object-cover h-85'  />
            <div className="absolute top-0 h-full pt-24 px-8 md:px-24 lg:32 xl:px-40 bg-linear-to-r from-black/80 to-white-50/50  ">
